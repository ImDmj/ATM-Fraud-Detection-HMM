...
public class CaptureForm
    ...
    public CaptureForm(Frame owner) {
        ...
        picture.setPreferredSize(new Dimension(180, 160));
...
//        String FileName=AddUser.Thumb.getText();
...
//        try {
//            ImageOutputStream imgout = ImageIO.createImageOutputStream(new File("c:\\BioAttendanceThumb\\Thumb\\"+FileName+".jpg"));
