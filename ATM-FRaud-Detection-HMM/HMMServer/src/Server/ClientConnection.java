...
import DBHandling.PinCode;
import DBHandling.SecurityCode;
import DBHandling.Transaction;
...
class ClientConnection implements Runnable {
    ...
    static private String keysStrings[] = {"", "id", "rfid", "balance", "checkpin", "checksecuritycode", "withdraw", "print", "changepin", "checkfraud"};
